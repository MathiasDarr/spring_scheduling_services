...
public class DataUtilities {
    ...
    public static String downloadS3Object(String bucket, String key) throws IOException{
        ...
        try {
            ...
            output = s3InputStreamToString(fullObject.getObjectContent());
...
//            displayTextInputStream(headerOverrideObject.getObjectContent());
    ...
    public static String s3InputStreamToString(InputStream input) throws IOException {
